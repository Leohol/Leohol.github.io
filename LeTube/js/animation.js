...
!function(a, b) {
    ...
    !function(a, b) {
        ...
        function q(a, b, c, d, e) {
            var f = e;
            return 0 === a ? b !== H && (f += c) : f += d / a,
            f
        }
        function r(a, b, c, d, e, f) {
            var g = a === 1 / 0 ? b % 1 : a % 1;
            return 0 !== g || c !== I || 0 === d || 0 === e && 0 !== f || (g = 1),
            g
        }
        function s(a, b, c, d) {
    ...
    function(a, b, c) {
        ...
        b.AnimationTimeline.prototype = {
            ...
            _play: function(a) {
                ...
                return this._animations.push(c),
    ...
    function(a, b, c) {
        ...
        b.removeMulti = function(a) {
            for (var b = [], c = 0; c < a.length; c++) {
                ...
                d._parent = null,
                f(d)) : d._animation && d._animation.effect == d && (d._animation.cancel(),
        ...
        b.KeyframeEffect = function(b, c, e, f) {
            ...
            "function" == typeof c ? (a.deprecated("Custom KeyframeEffect", "2015-06-22", "Use KeyframeEffect.onsample instead."),
            this._normalizedKeyframes = c) : this._normalizedKeyframes = new d(c),
            this._keyframes = c,
        ...
        b.awaitStartTime = function(a) {
            null === a.startTime && a._isGroup && (0 == i.length && requestAnimationFrame(e),
            i.push(a))
        }
        ;
        ...
        Object.defineProperty(window, "getComputedStyle", {
            ...
            value: function() {
                ...
                return e() && (a = j.apply(this, arguments)),
                b.timeline._updateAnimationsPromises(),
                a
            }
        }),
    ...
    function(a, b, c) {
        ...
        b.bindAnimationForCustomEffect = function(b) {
            ...
            var j = function() {
                ...
                null !== d && (d = a.calculateIterationProgress(a.calculateActiveDuration(h), d, h),
                isNaN(d) && (d = null)),
        ...
        b.newUnderlyingAnimationForGroup = function(c) {
            var d, e = null, f = function(b) {
                ...
                if (c && "pending" != c.playState && c.effect)
                    return null == b ? void c._removeChildAnimations() : 0 == b && c.playbackRate < 0 && (e || (e = a.normalizeTimingInput(c.effect.timing)),
